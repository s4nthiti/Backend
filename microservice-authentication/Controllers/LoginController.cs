...
namespace microservice_authentication.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        private List<User> appUsers = new List<User>{
            new User { FirstName = "Santhiti", LastName = "Traiyasakda", UserName = "administrator", Password = "1234", UserRole = "admin" },
            new User { FirstName = "Guest", LastName = "Unknown", UserName = "guest", Password = "1234", UserRole = "user" }
        };
